#!/usr/bin/env python3
"""Inner Compass Baseline 4: deterministic-only regression evaluation."""
...
RESULTS_DIR = "tools/eval/results/baseline-4-deterministic"
REPETITIONS = 4
...
def main():
    ...
    if summary["deterministicClassificationAccuracy"] < 96.0:
        raise SystemExit("FAIL: deterministic classification accuracy is below 96%")
