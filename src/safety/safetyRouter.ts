...
const SUBSTANCE_USE_REGEX = /\b(substance\s+use|substance\s+(addiction|dependence)|chemical\s+dependency|alcohol(ic|ism)?|alcohol\s+addiction|drug\s+addiction|drinking\s+too\s+much|blackout|detox|withdrawal|relapse(d)?|cocaine|heroin|fentanyl|meth|opioid(s)?|benzos?|binge\s+drinking|sober|sobriety)\b/i;
